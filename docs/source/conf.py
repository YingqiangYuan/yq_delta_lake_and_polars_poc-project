# -*- coding: utf-8 -*-
#
# yq_delta_lake_and_polars_poc documentation build configuration file, created by
...
package_name = "yq_delta_lake_and_polars_poc"
...
# Add data for Jinja2
try:
    from yq_delta_lake_and_polars_poc.docs import doc_data
except:
    doc_data = dict()
